...
define(['./workbox-fbf42581'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/(motionsites\.ai|shrug-person-78902957\.figma\.site|images\.higgs\.ai)\/.*/i, new workbox.CacheFirst({
    "cacheName": "portfolio-media",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 100,
